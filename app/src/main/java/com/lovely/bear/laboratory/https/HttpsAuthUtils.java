 ...
 * @describe: ssl
 * @author: chenzhibiao
 * @date: 2022/6/20 11:12 上午
 * @version: 1.0
 */
public class HttpsAuthUtils {
	...
	/**
	 * https双向认证
	 * bksFile 和 password -> 用于加载客户端的证书
	 * X509TrustManager -> 用于校验远程证书。如果需要自己校验，那么可以自己实现相关校验，如果不需要自己校验，那么传null即可
	 */
	...
	public static X509TrustManager UnSafeTrustManager = new X509TrustManager() {
		...
		public void checkClientTrusted(X509Certificate[] chain, String authType) throws CertificateException {
			Log.d("SSLTrustManager", "checkClientTrusted:======" );
		}

		@Override
		public void checkServerTrusted(X509Certificate[] chain, String authType) throws CertificateException {

			Log.d("SSLTrustManager", "checkServerTrusted:======" );
		...
		public X509Certificate[] getAcceptedIssuers() {
			Log.d("SSLTrustManager", "getAcceptedIssuers:======" );
