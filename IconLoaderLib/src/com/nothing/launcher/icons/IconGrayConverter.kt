...
class IconGrayConverter(val iconSize: Int) {
    ...
    fun grayAndDrawCircle(icon: Drawable): Bitmap {
        val mMonoIcon = gray(icon, iconSize)
    ...
    private fun gray(icon: Drawable, size: Int): Bitmap {
        ...
        val bitmap = BitmapUtils.toSquareBitmap(icon, iconSize)
        // 获取灰度和透明度
