...
public class DotRenderer {
    ...
    public void draw(Canvas canvas, DrawParams params) {
        ...
        // modify by henry {@
        float bitmapOffset = mBitmapOffset * params.radiusScale;
        ...
        // add by henry {
        final float circleScale = params.scale * params.radiusScale;
        canvas.scale(circleScale, circleScale);
        // @}
