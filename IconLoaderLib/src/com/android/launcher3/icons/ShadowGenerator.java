...
public class ShadowGenerator {
    ...
    public static final boolean CURRENT_SCALE = true;

    public static final float BLUR_FACTOR = 1.68f/48;
    // benny add for NOS-1373 @{
    public static final float NT_ADAPTIVE_ICON_SCALE_FACTOR = 1 - BLUR_FACTOR;
    // @}
    ...
    public static float getScaleForBounds(RectF bounds) {
        float scale = 1;
        // modify by henry {@
        if (ENABLE_SHADOWS && !CURRENT_SCALE) {
    ...
    public static class Builder {
        ...
        public Bitmap createPill(int width, int height, float r) {
            ...
            // modify by batterman for ABR-15371 {@
            int size = Math.max(1, center * 2);
            // @}
