...
public class FastBitmapDrawable extends Drawable implements Drawable.Callback {
    ...
    protected FastBitmapDrawable(Bitmap b, int iconColor) {
        ...
        // IconLoader lib will be compiled to aar to serve other app, hence use independent context within this module
        mScaleSize = SharedApplication.INSTANCE.getContext().getResources().getDimensionPixelSize(R.dimen.press_view_scale);
        // @}
    }
    ...
    protected boolean onStateChange(int[] state) {
        ...
        if (mIsPressed != isPressed) {
            ...
            if (mIsPressed) {
                ...
                //modify by henry {@
                float scale = 1f * (getMinimumWidth() + mScaleSize) / getMinimumWidth();
                mScaleAnimation = ObjectAnimator.ofFloat(this, SCALE, scale);
    ...
    public void updatePressAnim(boolean show) {
        mShowPressAnim = show;
    }
    // @}
}
