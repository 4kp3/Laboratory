...
public class ThemedIconDrawable extends FastBitmapDrawable {
    ...
    // Added by stephen.bi for NOS-1021 @{
    ...
    public static int[] getColors(Context context) {
        ...
        if (IconPackManager.Companion.getInstance().getSupportHueChangeOnThemedIcons()) {
            boolean isLight = (res.getConfiguration().uiMode & UI_MODE_NIGHT_MASK) != UI_MODE_NIGHT_YES;
            colors[0] = IconGrayConverter.Companion.getMonoBgColor(context, isLight);
            colors[1] = IconGrayConverter.Companion.getMonoFgColor(context, isLight);
        } else {
